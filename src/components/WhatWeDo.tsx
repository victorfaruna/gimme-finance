        ...
        <div className="sticky top-[-30rem] z-[-1] w-full bg-color-1 text-color-main p-[var(--x-padding)] flex flex-col items-center gap-8">
            <div className="t flex flex-col gap-4">
                ...
                <div className="flex gap-5 justify-center items-center">
                    <button className="item cursor-pointer w-[150px] border border-color-main/50 rounded-[2.5rem] p-5 flex items-center justify-center gap-2">
                        <svg
                        ...
                        <p className="text-[1rem]">App store</p>
                    </button>
                    <button className="item cursor-pointer w-[150px] border border-color-main/50 rounded-[2.5rem] p-5 flex items-center justify-center gap-2">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
