    ...
    <div className="outer-container w-full h-[85vh] lg:h-[98vh] [background-image:linear-gradient(151deg,_#000e4299_4%,_#fff0_80%),url('/images/hero-4.webp')] bg-cover bg-no-repeat bg-[center_bottom] px-[var(--x-padding)] flex items-center relative overflow-hidden">
      <div className="hero-text-container w-full lg:w-[55%] flex flex-col gap-8">
        <h1
          ...
          className="text-white text-[2.5rem] md:text-[3.5rem] lg:text-[4.5rem] font-bold leading-none tracking-[-0.02em]"
        >
        ...
        <div className="flex gap-4">
          <button
            ...
            className="bg-[#2467e3eb] backdrop-blur-[5px] hover:cursor-pointer py-[12px] lg:py-[15px] px-[20px] lg:px-[30px] text-[0.9rem] drop-shadow-xl rounded-md self-start text-white font-bold"
          >
            Join Our Waitlist
          </button>
          <button className="bg-[#efeeeceb] backdrop-blur-[5px] flex items-center justify-center gap-2 hover:cursor-pointer py-[12px] lg:py-[15px] px-[20px] lg:px-[30px] text-[0.9rem] drop-shadow-xl rounded-md self-start text-black font-bold">
            <svg
