    ...
    <main className="flex flex-col gap-[5rem] md:gap-[5rem]">
      ...
      <div className="flex gap-2 justify-center items-center">
        ...
        <div className="flex flex-col gap-2 md:gap-0">
          <p className="text-center text-[0.8rem] mx-[0.9rem] lg:text-[1.5rem] text-color-1/70 font-medium leading-none">
            We are building a financial inclusive world with everyone, for
            everyone using
            {/* We're building a financially inclusive world for all. */}
          </p>
          <div className="flex gap-1 lg:gap-2 items-center justify-center">
            <p className="text-[#5e19b3] font-bold text-[1.5rem] lg:text-[4rem] leading-none tracking-[-1px]">
              Blockchain and Ai.
            </p>
            <Image
